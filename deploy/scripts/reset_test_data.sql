...
DO $$ BEGIN
 ...
 WHERE NOT coalesce(e.payload->>'gateway_id'='demo-test-data'
   ...
   AND e.payload->'metadata'->>'dataset' IN
    ('dev-test-data-v1','dev-test-data-v2','dev-test-data-v3','dev-test-data-v4','dev-test-data-v5','dev-test-data-v6','dev-test-alerts-v1','dev-test-alerts-v2','dev-test-alerts-v3','dev-test-alerts-v4'),false))
